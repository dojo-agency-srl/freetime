...
const Team = () => {
  return (
    <div className="team">
		<div className="parallax_background parallax-window" style={{
				...
				{team.members.map((member, index) => (
					<div className="col-lg-4 team_col">
						<div className="team_item">
							<div className="team_image"><img src={member.image} alt="" /></div>
							<div className="team_panel d-flex flex-column align-items-center justify-content-center text-center">
								<div className="team_name"><a href="#">{member.name}</a></div>
